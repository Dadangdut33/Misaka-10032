...
If you want to clone it and use it for your server, you gonna have to change some stuff.
   ...
   - What you will need to modify
     ...
     4. **[Bot Token]** You need to add your own token to .env
     5. **[API Keys]** And last, You will also need to add your own API keys from bitly and rapidAPI if you want to use that command 
