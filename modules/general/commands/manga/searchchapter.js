    ...
    async run (message, args) {
        if(!args[0]){
            ...
            if (chaptersArray.length < 100){
                ...
                .setAuthor(`Showing a total of ${chap_Length} ${result.titles[reaction].title} chapter`, `https://media.discordapp.net/attachments/799595012005822484/822657390075445248/default_brand.png`, `https://mangadex.org/title/${result.titles[reaction].id}`)
