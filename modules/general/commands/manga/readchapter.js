    ...
    async run (message, args) {
        ...
        if (isNaN(args.join(" "))){
            ...
            for (var i = 0; i < amountOfPages; i++){
                ...
                .setAuthor(`${(await toRead).mangaTitle} Ch. ${(await toRead).chapter}`, 'https://media.discordapp.net/attachments/799595012005822484/822657390075445248/default_brand.png', `https://mangadex.org/chapter/${(await toRead).id}/${i}`)
        ...
        function info(){
            ...
            .setTitle('Invalid Parameter Inputted')
            .setDescription('Please enter correct arguments, for more info check using help command');
        ...
        function notANumber(){
            let embed = new MessageEmbed()
            .setTitle('Invalid ID inputted!')
            .setDescription(`Arguments inputted shoul be manga chapters id that you get from using the \`search\` command`);
