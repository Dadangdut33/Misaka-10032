...
module.exports = class extends Command {
	...
	async run(message, args) {
		if (!args[0]) {
			let embed = new MessageEmbed().setDescription(vaporize("Please enter the text that you want to") + ` *\"ｗｉｄｅｎ\"*`);
			...
			if (vaporized == "") {
				let embed = new MessageEmbed().setDescription("Please enter a correct text!");
